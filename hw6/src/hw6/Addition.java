...
public class Addition implements IOperation{
	public String perform(String num1, String num2){
		...
		if(sign_char_of_num1 != '-' && sign_char_of_num2 != '-') // () + () 
		{
			int carry = 0;
			int temp1 = 0, temp2 = 0;
			int last_number_of_the_char = array_size - 1;
			...
			{
					temp1 = (int)num1.charAt(last_number_of_the_char)- '0';
					temp2 = (int)num2.charAt(last_number_of_the_char)- '0';
		...
		}else if(sign_char_of_num1 == '-' && sign_char_of_num2 != '-') // -() + ()
		{
